                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            <h1>SOMOS A TUA <span id="js-rotating">SOLUÇÃO, ESTADIA, DIVERSÃO</span></h1>
                            <p class="p-heading p-large">Tenha Angola na palma da sua mão</p>
                            <a class="btn-solid-lg page-scroll" href="#intro">CONHECER</a>
                        </div>
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <h2 class="text-2xl font-bold">We Offer Some Of The Best Business Growth Services In Town</h2>
                ...
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="assets/images/IMG_0967.jpg" alt="alternative">
                    ...
                    <div class="slider-container">
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="assets/mages/testimonial-5.jpg" alt="alternative">
                                        <div class="card-body">
